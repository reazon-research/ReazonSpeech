...
from reazonspeech.espnet.asr import load_model, transcribe, audio_from_path, TranscribeConfig

warnings.filterwarnings("ignore")


class RSESPNETEvaluator(BaseEvaluator):
...
if __name__ == "__main__":
    ...
    evaluator = RSESPNETEvaluator(output_file=args.output_file)
